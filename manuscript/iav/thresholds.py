...
def main():
    parser = argparse.ArgumentParser(description="Compute dynamic distance thresholds.")
    ...
    if args.sourmash_jaccard or args.sourmash_cosine:
        D_jaccard, D_cosine, _ = read_SOURMASH(args.input_path)
    ...
    with open(args.output_path, "w") as f_out:
        f_out.write(f"{1.0-threshold:.8f}\n")
